...
import { useMemberships, MembershipPlan } from '@/hooks/use-memberships';
...
function MembershipsContent() {
  ...
  return (
    <>
      ...
      <div className="flex">
        <AdminSidebar />
        <main className="flex-1 ml-64 min-h-screen bg-gradient-to-b from-background via-background to-secondary/5 px-8 py-12">
