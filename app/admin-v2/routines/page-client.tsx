...
import { useAdmin, type Routine } from '@/hooks/use-admin';
import { ConfirmDialog } from '@/components/ui/confirm-dialog';
import { Skeleton } from '@/components/ui/skeleton';
import { Dumbbell, Layers, Plus } from 'lucide-react';

export default function AdminV2RoutinesPage() {
  const { routines, exercises, createRoutine, updateRoutine, deleteRoutine, refreshExercises, isLoading } = useAdmin();
    ...
    <div className="space-y-6">
      ...
      <PrimeKpiStrip
        items={[
          ...
          { label: 'Total ejercicios', value: exercises.length, icon: Dumbbell },
          { label: 'Ejercicios usados', value: exercisesUsed, icon: Dumbbell },
        ]}
      />
